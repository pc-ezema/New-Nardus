...
<main id="content" class="content-wrapper">
    <section id="field_0">
        <div id="c965" class="frame frame-default ctype-iffcomponents_flexible tx-iff-components-flexible layout-5 image-width-medium images-0">
            <div class="h2" style="text-align: center;">From Nature to Home: A Natural Path to Wellness</div>
        </div>
        <div id="c32" class="frame frame-default ctype-iffcomponents_multibox with-shape-1">
            ...
            <div class="multibox__boxes">
                <article class="multibox__box">
                    ...
                    <p style="text-align: justify;">Lemongrass Essential Oil offers the natural solution consumers seek.
                ...
                <article class="multibox__box">
                    ...
                    <p style="text-align: justify;">Scent leaf oil is crafted by experts to nourishes, soothes and promotes healthy complexion. Rich in nutrients, it combats dryness & irritation for natural, radiant glow. Embrace nature's secret for beautiful and balanced skin.</p>
                </article>
            </div>
        </div>

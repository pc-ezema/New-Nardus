    ...
    <section id="field_0">
        ...
        <div id="c967" class="frame frame-default ctype-iffcomponents_flexible tx-iff-components-flexible layout-2 image-width-medium images-1">
            ...
            <div class="right flexible__image-container">
                <div class="flexible__image lazyloaded" data-lazyload-400-src="{{URL::asset('assets/images/scentAmbienceScent.jpg')}}" data-lazyload-600-src="{{URL::asset('assets/images/scentAmbienceScent.jpg')}}" data-lazyload-800-src="{{URL::asset('assets/images/scentAmbienceScent.jpg')}}" style="background-image: url(&quot;{{URL::asset('assets/images/scentAmbienceScent.jpg')}}&quot;);">

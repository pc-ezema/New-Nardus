...
<?php
$limit_bestseller				= broxi_get_config('bestseller_limit',9);
$product_visibility_term_ids 	= wc_get_product_visibility_term_ids();
$product_col_large		= broxi_get_config('product_col_large',4);	
$product_col_medium 	= broxi_get_config('product_col_medium',3);
$product_col_sm 		= broxi_get_config('product_col_sm',1);
$product_col_xs 		= broxi_get_config('product_col_xs',1);
if( $id_category != 0 ){
	$args = array(
		'post_type'				=> 'product',
		'post_status' 			=> 'publish',
...
<div class="bestseller-product">
	<div class="title-box">
		<h2 class="title-bestseller"><?php echo esc_html__("Bestseller Products","broxi") ?></h2>
		<a class="view-all" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php echo esc_html__("View all products","broxi") ?></a>
	</div>

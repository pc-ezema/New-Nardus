...
<?php
		 ...
		 * @hooked broxi_woocommerce_breadcrumb - 20
		 */
...
<div class="clearfix">
	<div class="contents-detail">
		<div class="main-single-product<?php if( is_active_sidebar('sidebar-product') && $sidebar_detail_product != 'full' ) { ?> sidebar<?php } ?>">
			...
			<?php endif; ?>			
			<div class="<?php echo esc_attr(broxi_get_class()->class_detail_product_content); ?> <?php if(is_active_sidebar('sidebar-product') && $sidebar_detail_product == 'left'){ echo "pull-right"; } ?>">

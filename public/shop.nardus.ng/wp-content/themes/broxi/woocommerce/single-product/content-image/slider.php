...
<div class="images">
	<figure class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
		<div class="image-additional slick-carousel" data-slidestoscroll="true" data-nav="true" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="2" data-columns1="2" data-columns="3">
			<?php
			$attributes = array(
				'id'						=> "image", 	
				'title'                   => $image_title,

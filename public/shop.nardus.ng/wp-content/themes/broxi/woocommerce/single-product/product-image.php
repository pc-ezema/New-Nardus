...
elseif(broxi_image_single_product()->product_layout_thumb == "sticky")
	wc_get_template( 'single-product/content-image/sticky.php' );
elseif(broxi_image_single_product()->product_layout_thumb == "sticky2")
	wc_get_template( 'single-product/content-image/sticky2.php' );
elseif(broxi_image_single_product()->product_layout_thumb == "slider")
	wc_get_template( 'single-product/content-image/slider.php' );
elseif(broxi_image_single_product()->product_layout_thumb == "large_grid")
	wc_get_template( 'single-product/content-image/large_grid.php' );
elseif(broxi_image_single_product()->product_layout_thumb == "small_grid")

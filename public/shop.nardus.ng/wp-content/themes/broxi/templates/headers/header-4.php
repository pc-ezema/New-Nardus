						...
						<div class="row">
							...
							<div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12 header-right">
								<div class="header-phone">
									<?php if( isset($broxi_settings['phone']) && $broxi_settings['phone'] ) { ?>
										<div class="phone">
											<label class="font-bold"><?php echo esc_html__("CALL US FREE ","broxi") ?></label>
											<a href="tel:<?php echo esc_html($broxi_settings['phone']); ?>"><?php echo esc_html($broxi_settings['phone']); ?></a>
										</div>
									<?php } ?>
								</div>
								<div class="account">
									<?php if (is_user_logged_in()) { ?>
										<a href="<?php echo wp_logout_url( get_permalink( wc_get_page_id( 'myaccount' ) ) ); ?>"><i class="icon-logout hidden-md"></i><?php echo esc_html__('Logout', 'broxi')?></a>
									<?php }else{ ?>
										<div class="active-login">
											<h2><i class="icon-login hidden-md"></i><?php echo esc_html__('Login', 'broxi')?></h2>
										</div>
									<?php } ?>
								</div>

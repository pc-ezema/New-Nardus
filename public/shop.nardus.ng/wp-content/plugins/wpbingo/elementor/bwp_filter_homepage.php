...
class Bwp_Filter_Homepage extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'icon_image',
			[
				'label' => __( 'Choose Icon Image', 'wpbingo' ),
		...
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_product_slider_4","tab_product_slider_5","tab_category_slider_3","tab_category_slider_4","tab_category_icon"],
                ]				
			]
		);
		$this->add_control(
			...
			[
				...
				'condition'   => [
                    'layout' => ["tab_category_slider","tab_category_icon","tab_product_slider","tab_category_slider_2","tab_product_slider_2","tab_product_slider_3",
					"tab_product_slider_4","tab_category_slider_3","tab_category_slider_4","tab_category_slider_5","tab_category_icon"],
                ]				
			]
		);
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_category_slider_5","tab_category_icon"],
                ]				
			]
		);
		$this->add_control(
			...
			[
				...
				'condition'   => [
					...
					"tab_category_slider_4","tab_category_slider_5","tab_category_icon"],
                ]				
			]
		);		
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'tab_category_icon'  		=> __( 'Tab Category Icon', 'wpbingo' ),
				],
			]
		);		
	...
	protected function render() {
		...
		$icon_image		 = 	( $settings['icon_image'] && $settings['icon_image']['url'] ) ? $settings['icon_image']['url'] : '';
		if( $layout == 'default' ){
		...
		}elseif( $layout == 'tab_category_slider' || $layout == 'tab_category_slider_3' ){
			include(WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-filter-homepage/tab-category/slider-2.php' );
		}elseif( $layout == 'tab_category_icon' ){
			include(WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-filter-homepage/tab-category/icon.php' );
		}elseif( $layout == 'tab_product_default' ){
			include(WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-filter-homepage/tab-product/default.php' );
		}elseif( $layout == 'tab_product_slider' ||  $layout == 'tab_product_slider_2' ){

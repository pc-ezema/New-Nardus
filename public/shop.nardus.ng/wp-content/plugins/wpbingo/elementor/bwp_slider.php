...
class Bwp_Slider extends Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'gallery'  => __( 'Gallery', 'wpbingo' ),
					'gallery1'  => __( 'Gallery 1', 'wpbingo' ),
				],
			]
		);		
		$this->end_controls_section();
	...
	protected function render() {
		...
		}elseif( $settings['layout'] == 'gallery' || $settings['layout'] == 'gallery1' ){
			include(WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-slider/gallery.php' );
		}
	}
}

...
class Bwp_Product_List extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '0',
				'condition'   => [
                    'layout' => ["slider","slider2","slider3","slider4","slider5","slider6","slider7","slider8","slider9","slider10","list-deal"],
                ]				
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'product-menu' 	=> __( 'Product List Menu', 'wpbingo' )
				],
			]
		);		
	...
	protected function render() {
		...
		if( $layout == 'default' ){
			...
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/slider4.php' );			
		}elseif( $layout == 'slider3' ){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/slider3.php' );			
		}elseif( $layout == 'slider2' ){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/slider5.php' );			
		}elseif( $layout == 'slider6' ){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/slider6.php' );			
		}elseif( $layout == 'list-deal' ){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/list-deal.php' );			
		}elseif( $layout == 'product-menu' ){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-list/product-menu.php' );			

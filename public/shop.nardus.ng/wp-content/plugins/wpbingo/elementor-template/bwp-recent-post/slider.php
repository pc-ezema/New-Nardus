						...
						<div class="post-inner style">
							...
							<div class="post-content">
								<div class="content-post">
									...
									<div class="entry-meta-head">
										<?php if (broxi_get_config('archives-author')) { ?>
											<div class="entry-author">
												<span class="entry-meta-link"><i class="icon-user" aria-hidden="true"></i><?php echo esc_html__("By : ","wpbingo") ?><?php echo the_author_posts_link(); ?></span>
											</div>
										<?php } ?>
									...
									<div class="btn-read-more"><a class="read-more" href="<?php the_permalink() ?>"><?php echo esc_html__("Continue reading","wpbingo") ?></a></div>
								</div>
							</div>
						</div>
					</div><!-- #post-## -->

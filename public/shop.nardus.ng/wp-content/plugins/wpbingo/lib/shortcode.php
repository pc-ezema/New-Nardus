<?php
	...
	$content = '<ul class="social-link">';
		if($broxi_settings['link-tw'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-tw']).'"><i class="fa fa-twitter"></i></a></li>';
		if($broxi_settings['link-instagram'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-instagram']).'"><i class="fa fa-instagram"></i></a></li>';
		if($broxi_settings['link-fb'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-fb']).'"><i class="fa fa-facebook"></i></a></li>';
		if($broxi_settings['link-youtube'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-youtube']).'"><i class="fa fa-youtube"></i></a></li>';
		if($broxi_settings['link-linkedin'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-linkedin']).'"><i class="fa fa-linkedin"></i></a></li>';
		if($broxi_settings['link-pinterest'])
			$content .= '<li><a href="'.esc_url($broxi_settings['link-pinterest']).'"><i class="fa fa-pinterest"></i></a></li>';
	$content .= '</ul>';
	return $content; 
	}
	...
	function wpbingo_social_share_shortcode() {
		global $post,$broxi_settings;
		
		if (!$broxi_settings['social-share']) return false;
		...
		if ($broxi_settings['share-linkedin']) {
		...
		if ($broxi_settings['share-pinterest']) {
